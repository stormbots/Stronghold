 ...
 *
 */
public class ShooterSetSpeedForMidPowerShot extends Command {

    public ShooterSetSpeedForMidPowerShot(double maxWaitTime) {
    ...
    protected void execute() {
    	...
    	double rawVelocity = 7375;// Doesn't actually work for shooting at batter Robot Doen't Shoot from Batter
