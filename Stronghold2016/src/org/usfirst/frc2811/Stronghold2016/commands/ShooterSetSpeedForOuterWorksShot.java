 ...
 *
 */
public class ShooterSetSpeedForOuterWorksShot extends Command {

    public ShooterSetSpeedForOuterWorksShot(double maxWaitTime) {
    	    ...
    	    protected void execute() {
    	    	...
    	    	double rawVelocity = 36702;//TODO Change this value for the Outer Works
